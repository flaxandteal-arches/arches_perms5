"""
Django settings for arches_perms5 project.
"""
...
DATATYPE_LOCATIONS.append("arches_perms5.datatypes")
FUNCTION_LOCATIONS.append("arches_perms5.functions")
ETL_MODULE_LOCATIONS.append("arches_perms5.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_perms5.search_components")
...
SECRET_KEY = "django-insecure-^3!^v0oqwoalqiz#nu40aj^bxj!y6sz$x_mgnhrm%+*5=os=(("

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_perms5.urls"
ROOT_HOSTCONF = "arches_perms5.hosts"

DEFAULT_HOST = "arches_perms5"
...
ELASTICSEARCH_PREFIX = "arches_perms5"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_perms5.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_perms5",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_perms5.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_perms5"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_perms5.search.es_mapping_modifier.EsMappingModifier"]
